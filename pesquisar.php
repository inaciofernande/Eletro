				...
				<div class="row">
					...
					<div id="aside" class="col-md-3">
						...
						<div class="aside">
							...
							<?php
											$sql = "SELECT * FROM carrinho_produto WHERE produto_tipo='+Vendido'";
											$result = $link->query($sql);
											$result->num_rows;
											if ($result->num_rows > 0) {
											 while($row = $result->fetch_assoc()) {
												  if($row['produto_tipo']=="+Vendido" && $result->num_rows <=4){
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							<?php          $pesquisar = $_POST['pesquisar'];
											$sql = "SELECT * FROM carrinho_produto WHERE produto_nome LIKE '%$pesquisar%'";
											$result = $link->query($sql);
											$result->num_rows;
											if ($result->num_rows > 0) {
											 while($row = $result->fetch_assoc()) {
